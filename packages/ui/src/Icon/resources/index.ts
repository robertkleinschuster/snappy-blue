...
import oebbLightResource from "./OEBB-Light-Icon-Pack";
import cdResource from "./CD-Icon-Pack";
...
export const ICONS_OEBB_LIGHT = oebbLightResource.fontFamily;
export const ICONS_CD = cdResource.fontFamily;
...
resources.add(oebbLightResource);
resources.add(cdResource);
